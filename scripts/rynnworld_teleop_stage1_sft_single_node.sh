...
# Single-node multi-GPU launch script for RynnWorld-Teleop Stage 1 SFT training
# Usage: bash scripts/rynnworld_teleop_stage1_sft_single_node.sh
...
finetune.py \
    ...
    --training_type sft \
    --output_dir training/rynnworld-teleop-stage1-sft \
