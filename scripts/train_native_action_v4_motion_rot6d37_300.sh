...
export MASTER_PORT="${MASTER_PORT:-29726}"
...
accelerate launch --config_file configs_acc/1gpu_smoke.yaml finetune.py \
  ...
  --freeze_lora true \
  --condition_mode native_trajectory --native_conditioner_version v4 \
  ...
  --output_dir training/native_action_v4_motion_rot6d37_300 \
