#!/usr/bin/env python3
"""Build run_005 full-range, episode-stratified contiguous-window manifest."""
...
OUT = REPO / 'reports/direct_action/gate_c/run_005'
WINDOW = 33
STRIDE = 16
...
def main():
    ...
    manifest = {
        'run_id': 'direct_action/gate_c/run_005',
    ...
    (OUT / 'artifacts/window_manifest_full_range.json').write_text(json.dumps(manifest, indent=2))
    print(json.dumps({
        ...
        'out': str(OUT / 'artifacts/window_manifest_full_range.json'),
    }, indent=2))
